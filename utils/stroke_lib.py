...
class Stroke:
  ...
  def extract_strokes(self, vs, ts, T=50):
    try:
      ...
      return [(vs[p0:p2], ts[p0:p2]) for p0, p1, p2 in strokes], mean_period, len(strokes)
    except Exception as e:
      print(f"An error occurred: {e}")
      return [], 0, 0  # or any other appropriate handling for your case
